...
public class RNByronVlcModule extends ReactContextBaseJavaModule {


    private RNByronVlc videoView;
    private RNByronVlcManager playerManager;
    private Equalizer mEqualizer;

    public RNByronVlcModule(ReactApplicationContext reactContext, RNByronVlcManager playerManager) {
